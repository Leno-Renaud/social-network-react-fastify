        ...
        return (
            <div className={styles.dashboard}>
                ...
                <div className={styles.dashHero}>
                    ...
                    <div className={styles.dashHeroEmoji}>🌍</div>
                </div>
                ...
                <div className={styles.dashTip}>
                    <span className={styles.dashTipIcon}>💡</span>
        ...
        <div className={styles.landing}>
            ...
            <section className={styles.hero}>
                ...
                <div className={styles.heroStats}>
                    <div className={styles.stat}><strong>✈️</strong><span>Voyages partagés</span></div>
                    <div className={styles.statDivider}/>
                    <div className={styles.stat}><strong>📅</strong><span>Événements actifs</span></div>
                    <div className={styles.statDivider}/>
                    <div className={styles.stat}><strong>💬</strong><span>Messages échangés</span></div>
                </div>
            </section>
            ...
            <section className={styles.features}>
                ...
                <div className={styles.featureGrid}>
                    <div className={styles.featureCard}>
                        <div className={`${styles.featureIcon} ${styles.blue}`}>🗺️</div>
